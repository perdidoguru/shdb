...
local function parryInternal()
    if isMobile() then
        local mobileDeflect = playerGui:FindFirstChild("MobileButtonsGUI")
...
--// Globals
local toolbar, deflectButton, deflectGradient, abilityButtons

if not isMobile() then
    toolbar         = playerGui:WaitForChild("HUD"):WaitForChild("HolderBottom"):WaitForChild("ToolbarButtons")
    deflectButton   = toolbar:WaitForChild("DeflectButton")
    deflectGradient = deflectButton:WaitForChild("Cooldown"):WaitForChild("UIGradient")
    abilityButtons  = {
